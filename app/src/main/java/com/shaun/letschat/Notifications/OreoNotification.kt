...
class OreoNotification(base: Context?) : ContextWrapper(base) {
    ...
    companion object {
        private const val CHANNEL_ID = "com.shaun.letschat"
        private const val CHANNEL_NAME = "Lets Chat"
    }
    ...
    private fun createChannel() {
        ...
        channelName.enableLights(false)
        channelName.enableVibration(true)
        channelName.lockscreenVisibility = Notification.VISIBILITY_PRIVATE
        getManager!!.createNotificationChannel(channelName)
    }
